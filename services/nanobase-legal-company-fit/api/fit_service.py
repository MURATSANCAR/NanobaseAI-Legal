...
from domain.models import CompanyDocument, CompanyFitReport
from extract.capability_extractor import extract_from_documents
from fit.fit_engine import build_fit_report
