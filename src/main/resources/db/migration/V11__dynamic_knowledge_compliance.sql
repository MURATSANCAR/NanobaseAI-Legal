...
-- Starter vocabulary is catalog data, not a closed application enum. Tenants can
-- extend/override it without schema, controller or frontend changes.
INSERT INTO ontology_concept (
    id, organization_id, ontology_version_id, parent_concept_id, concept_code,
    name, description, concept_type, metadata_json, active, sort_order, created_at
) VALUES
    ('50000000-0000-0000-0000-0000000000a0', NULL,
     '40000000-0000-0000-0000-000000000002',
     '50000000-0000-0000-0000-000000000001', 'COMPANY', 'Firma',
     'Generic organization knowledge entity', 'ENTITY_TYPE',
     '{"profileCode":"ENTITY_PROFILE"}', TRUE, 10, now()),
    ('50000000-0000-0000-0000-0000000000a1', NULL,
     '40000000-0000-0000-0000-000000000002',
     '50000000-0000-0000-0000-000000000001', 'PRODUCT', 'Ürün',
     'Generic product knowledge entity', 'ENTITY_TYPE',
     '{"profileCode":"ENTITY_PROFILE"}', TRUE, 20, now()),
    ('50000000-0000-0000-0000-0000000000a2', NULL,
     '40000000-0000-0000-0000-000000000002',
     '50000000-0000-0000-0000-000000000001', 'CERTIFICATE_ENTITY', 'Sertifika',
     'Generic certificate knowledge entity', 'ENTITY_TYPE',
     '{"profileCode":"ENTITY_PROFILE"}', TRUE, 30, now()),
    ('50000000-0000-0000-0000-0000000000a3', NULL,
     '40000000-0000-0000-0000-000000000002',
     '50000000-0000-0000-0000-000000000001', 'PERSONNEL', 'Personel',
     'Generic personnel knowledge entity', 'ENTITY_TYPE',
     '{"profileCode":"ENTITY_PROFILE","sensitive":true}', TRUE, 40, now()),
    ('50000000-0000-0000-0000-0000000000a4', NULL,
     '40000000-0000-0000-0000-000000000002',
     '50000000-0000-0000-0000-000000000001', 'REFERENCE_PROJECT', 'Referans proje',
     'Generic reference project entity', 'ENTITY_TYPE',
     '{"profileCode":"ENTITY_PROFILE"}', TRUE, 50, now()),
    ('50000000-0000-0000-0000-0000000000b0', NULL,
     '40000000-0000-0000-0000-000000000002',
     '50000000-0000-0000-0000-000000000008', 'PRODUCT_CATALOG', 'Ürün kataloğu',
     NULL, 'DOCUMENT_ROLE', '{"sourceAuthorityType":true}', TRUE, 10, now()),
    ('50000000-0000-0000-0000-0000000000b1', NULL,
     '40000000-0000-0000-0000-000000000002',
     '50000000-0000-0000-0000-000000000008', 'CERTIFICATE', 'Sertifika belgesi',
     NULL, 'DOCUMENT_ROLE', '{"sourceAuthorityType":true}', TRUE, 20, now()),
    ('50000000-0000-0000-0000-0000000000b2', NULL,
     '40000000-0000-0000-0000-000000000002',
     '50000000-0000-0000-0000-000000000008', 'TEST_REPORT', 'Test raporu',
     NULL, 'DOCUMENT_ROLE', '{"sourceAuthorityType":true}', TRUE, 30, now()),
    ('50000000-0000-0000-0000-0000000000c0', NULL,
     '40000000-0000-0000-0000-000000000002',
     '50000000-0000-0000-0000-00000000000a', 'AND', 'And',
     NULL, 'LOGICAL_OPERATOR', '{"provider":"ALL"}', TRUE, 10, now()),
    ('50000000-0000-0000-0000-0000000000c1', NULL,
     '40000000-0000-0000-0000-000000000002',
     '50000000-0000-0000-0000-00000000000a', 'OR', 'Or',
     NULL, 'LOGICAL_OPERATOR', '{"provider":"ANY"}', TRUE, 20, now()),
    ('50000000-0000-0000-0000-0000000000c2', NULL,
     '40000000-0000-0000-0000-000000000002',
     '50000000-0000-0000-0000-00000000000a', 'NOT', 'Not',
     NULL, 'LOGICAL_OPERATOR', '{"provider":"NOT"}', TRUE, 30, now()),
    ('50000000-0000-0000-0000-0000000000c3', NULL,
     '40000000-0000-0000-0000-000000000002',
     '50000000-0000-0000-0000-00000000000a', 'AT_LEAST_N', 'At least N',
     NULL, 'LOGICAL_OPERATOR', '{"provider":"AT_LEAST_N"}', TRUE, 40, now());
...
INSERT INTO policy_version (
    ...
    ('50000000-0000-0000-0000-000000000041', NULL,
     ...
     '{"factors":{"notExpired":0.35,"parserQuality":0.15,"ocrQuality":0.10,
                  "verified":0.20,"authority":0.20},"minimumUsableScore":0.55,
       "selectors":{"usable":"usable","expired":"expired",
                    "indeterminate":"indeterminate"}}'::jsonb,
     'ACTIVE', 'platform', now(), now()),
